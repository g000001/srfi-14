...
(defpackage "https://github.com/g000001/srfi-14"
  (:use)
  (:export
   ...
   char-set-count char-set-contains? char-set-every char-set-any
  ...
  (:export
   ...
   char-set$hex-digit char-set$blank char-set$ascii char-set$empty
   char-set$full))

(defpackage "https://github.com/g000001/srfi-14#internals"
  (:use "https://github.com/g000001/srfi-14"
